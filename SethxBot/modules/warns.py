...
from SethxBot.modules.helper_funcs.string_handling import split_quotes
from SethxBot.modules.log_channel import loggable
from SethxBot.modules.sql import warns_sql as sql
...
def warn(
    ...
    if num_warns >= limit:
        ...
        # message.bot.send_sticker(chat.id, BAN_STICKER)  # Seth's sticker
        keyboard = None
        log_reason = (
