...
from SethxBot.__main__ import STATS, TOKEN, USER_INFO
import SethxBot.modules.sql.userinfo_sql as sql
from SethxBot.modules.disable import DisableAbleCommandHandler
from SethxBot.modules.sql.global_bans_sql import is_user_gbanned
from SethxBot.modules.sql.afk_sql import is_afk, check_afk_status
from SethxBot.modules.sql.users_sql import get_user_num_chats
from SethxBot.modules.helper_funcs.chat_status import sudo_plus
from SethxBot.modules.helper_funcs.extraction import extract_user
from SethxBot import telethn as SethTelethonClient, TIGERS, DRAGONS, DEMONS
...
def info(update: Update, context: CallbackContext):
    ...
    if user.id == OWNER_ID:
        ...
        text += "\n\nThe Disaster level of this person is 'RADIANT'."
        disaster_level_present = True
    ...
    if disaster_level_present:
        text += ' [<a href="https://t.me/SETH_UPDATES">?</a>]'.format(bot.username)
...
def set_about_bio(update: Update, context: CallbackContext):
    ...
    if message.reply_to_message:
        ...
        if user_id == bot.id and sender_id not in DEV_USERS:
            message.reply_text("Erm... yeah, I only trust RADIANT to set my bio.")
            return
...
*What is that health thingy?*
 Come and see [HP System explained](https://t.me/SETH_UPDATES)
"""
