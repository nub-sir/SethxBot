...
import SethxBot.modules.sql.global_bans_sql as gban_sql
import SethxBot.modules.sql.users_sql as user_sql
from SethxBot import DEV_USERS, OWNER_ID, dispatcher
