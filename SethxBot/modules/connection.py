...
import SethxBot.modules.sql.connection_sql as sql
from SethxBot import dispatcher, DRAGONS, DEV_USERS
from SethxBot.modules.helper_funcs import chat_status
